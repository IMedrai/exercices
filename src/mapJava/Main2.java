...
public class Main2 {
   public static void main(String[] args){
      ...
      set1.add(new CD("tset", "Bongo Fury", 10.25d));
      ...
      //en lui spécifiant sa façon de ranger les objets
       ...
       Set<CD> set2 = new TreeSet<CD>(new Comparator<CD>(){
         public int compare(CD cd1, CD cd2) {
            String auteur1 = (String)cd1.getAuteur();
            String auteur2 = (String)cd2.getAuteur();
            int result = auteur1.compareTo(auteur2);
            //dans le cas ou 2 CD auraient le même auteur...
            if(result == 0){
